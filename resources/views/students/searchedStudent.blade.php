                    ...
                    <form action="{{route("student.search")}}" method="post">
                        ...
                        <label for="searchOption">
                            ...
                            <select name="type"  id="searchOption"  class="form-control">
                                <option value="roll" @selected($searchType == 'roll')> Search Student Roll</option>
                                <option value="reg" @selected($searchType == 'reg')> Search Student Registation</option>
                                <option value="name" @selected($searchType == 'name')>Search Student Name</option>
                                <option value="tech" @selected($searchType == 'tech')>Search With Technoloy</option>
                                <option value="semester" @selected($searchType == 'semester')>Search With Semester</option>
                                <option value="group" @selected($searchType == 'group')>Search With Group</option>
                                <option value="session" @selected($searchType == 'session')>Search With Session</option>
                            </select>
                        </label>
                        <label>
                            <input required type="text" id="inputText" value="{{ $searchText }}" name="searchText" class="form-control" placeholder="Type here" aria-controls="dataTableExample">
                        </label>
                    </form>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <table id="dataTableExample" class="table dataTable no-footer" role="grid" aria-describedby="dataTableExample_info">       
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td >
                                            <a title="Show single student" href="{{route('student.show',['id' => $student->id])}}" title="show student" class="btn ">
                                            ...
                                            <a title="Modify student" href="{{route('student.edit',['student' => $student->id])}}" title="edit student" class="btn ">
                                            ...
                                            <a title="Delete student" href="{{route('student.destroy',['id' => $student->id])}}" class="btn" title="delete student">
